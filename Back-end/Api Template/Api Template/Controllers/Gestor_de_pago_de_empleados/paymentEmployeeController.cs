...
using Api_control_comercio.Utils.Manager.Gestor_de_pago_de_empleados;
using System;
...
namespace Api_control_comercio.Controllers.Gestor_de_pago_de_empleados
{
    public class paymentEmployeeController : ApiController
    {
        ...
        public IHttpActionResult GetAll([FromUri] Guid Location)
        {
            try
            {
                return Ok(paymentEmployeeManager.Current.GetAllLocation(Location));
            }
