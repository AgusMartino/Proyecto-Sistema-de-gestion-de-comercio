...
namespace Api_control_comercio.Utils.Manager.Gestor_de_productos
{
    public class inventoryManager : IGenericCRUD<inventoryBody>
    {
        ...
        public void Remove(Guid id)
        {
            using (var db = new sistema_control_comercio())
            {
                ...
                inventary.physical_location_id = obj.inventary.physical_location_id;
                inventary.raw_material_id = obj.rawMaterial.raw_material_id;
                inventary.quantity = (int)obj.inventary.quantity;
        ...
        public void Update(inventoryBody obj)
        {
            ...
            {
                inventary inventary = new inventary();
                inventary.quantity = obj.inventary.quantity;
                inventary.physical_location_id = obj.inventary.physical_location_id;
                inventary.inventary_id = obj.inventary.inventary_id;
                inventary.raw_material_id = obj.rawMaterial.raw_material_id;
                inventary.modification_date = DateTime.Now;

                var obj_db = db.inventary.SingleOrDefault(b => b.inventary_id == obj.inventary.inventary_id);
